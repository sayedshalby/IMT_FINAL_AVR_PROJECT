...
static void Lcd_SendCommand(u8 command) {
    DIO_voidSetPinValue(LCD_PIN_RS, DIO_u8_LOW);
    DIO_voidSetPinValue(LCD_PIN_RW, DIO_u8_LOW);
#if LCD_MODE == LCD_MODE_8_BIT
    DIO_voidSetPinValue(LCD_PIN_D0, GET_BIT(command, 0));
    DIO_voidSetPinValue(LCD_PIN_D1, GET_BIT(command, 1));
    DIO_voidSetPinValue(LCD_PIN_D2, GET_BIT(command, 2));
    DIO_voidSetPinValue(LCD_PIN_D3, GET_BIT(command, 3));
#endif
    DIO_voidSetPinValue(LCD_PIN_D4, GET_BIT(command, 4));
    DIO_voidSetPinValue(LCD_PIN_D5, GET_BIT(command, 5));
    DIO_voidSetPinValue(LCD_PIN_D6, GET_BIT(command, 6));
    DIO_voidSetPinValue(LCD_PIN_D7, GET_BIT(command, 7));
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_HIGH);
    _delay_ms(2);
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_LOW);
#if LCD_MODE == LCD_MODE_4_BIT
    DIO_voidSetPinValue(LCD_PIN_D4, GET_BIT(command, 0));
    DIO_voidSetPinValue(LCD_PIN_D5, GET_BIT(command, 1));
    DIO_voidSetPinValue(LCD_PIN_D6, GET_BIT(command, 2));
    DIO_voidSetPinValue(LCD_PIN_D7, GET_BIT(command, 3));
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_HIGH);
    _delay_ms(2);
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_LOW);
#endif
...
static void Lcd_SendData(u8 data) {
    DIO_voidSetPinValue(LCD_PIN_RS, DIO_u8_HIGH);
    DIO_voidSetPinValue(LCD_PIN_RW, DIO_u8_LOW);
#if LCD_MODE == LCD_MODE_8_BIT
    DIO_voidSetPinValue(LCD_PIN_D0, GET_BIT(data, 0));
    DIO_voidSetPinValue(LCD_PIN_D1, GET_BIT(data, 1));
    DIO_voidSetPinValue(LCD_PIN_D2, GET_BIT(data, 2));
    DIO_voidSetPinValue(LCD_PIN_D3, GET_BIT(data, 3));
#endif
    DIO_voidSetPinValue(LCD_PIN_D4, GET_BIT(data, 4));
    DIO_voidSetPinValue(LCD_PIN_D5, GET_BIT(data, 5));
    DIO_voidSetPinValue(LCD_PIN_D6, GET_BIT(data, 6));
    DIO_voidSetPinValue(LCD_PIN_D7, GET_BIT(data, 7));
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_HIGH);
    _delay_ms(2);
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_LOW);
#if LCD_MODE == LCD_MODE_4_BIT
    DIO_voidSetPinValue(LCD_PIN_D4, GET_BIT(data, 0));
    DIO_voidSetPinValue(LCD_PIN_D5, GET_BIT(data, 1));
    DIO_voidSetPinValue(LCD_PIN_D6, GET_BIT(data, 2));
    DIO_voidSetPinValue(LCD_PIN_D7, GET_BIT(data, 3));
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_HIGH);
    _delay_ms(2);
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_LOW);
#endif
...
static void Lcd_Enter_4Bit_Mode(void) {
    DIO_voidSetPinValue(LCD_PIN_RS, DIO_u8_LOW);
    DIO_voidSetPinValue(LCD_PIN_RW, DIO_u8_LOW);
    DIO_voidSetPinValue(LCD_PIN_D4, DIO_u8_LOW);
    DIO_voidSetPinValue(LCD_PIN_D5, DIO_u8_HIGH);
    DIO_voidSetPinValue(LCD_PIN_D6, DIO_u8_LOW);
    DIO_voidSetPinValue(LCD_PIN_D7, DIO_u8_LOW);
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_HIGH);
    _delay_ms(2);
    DIO_voidSetPinValue(LCD_PIN_EN, DIO_u8_LOW);
}
